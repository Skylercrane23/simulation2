          ...
          <form className="steps-form">
              <div className="row">
                <div className="input-field col s12">
                  ...
                  <label htmlFor="textarea1">Enter your desired rent:</label>
                </div>
                  ...
                  <div className="input-field col s6 right-align">
                    <Link to="/dashboard">
                      <button className="login green lighten-1 btn waves-effect waves-light" type="submit" name="action">Finish <i className="material-icons right">check</i></button>
                    </Link>
                  </div>
